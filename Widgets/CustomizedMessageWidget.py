...
class MessageDialog(QDialog):
    def __init__(self, auto_close=False, sec=2, parent=None):
        ...
        self.setWindowOpacity(0.98)  # setting window opacity
        self.setAttribute(Qt.WA_TranslucentBackground)  # set window optical
...
class AskDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.yes_btn = QPushButton(u"Confirm")
        self.yes_btn.setObjectName("yes_btn")
        self.no_btn = QPushButton(u"Cancel")
...
class InputMessageDialog(QDialog):
    input_text = ""

    def __init__(self, title, text, parent=None):
        super(InputMessageDialog, self).__init__(parent)
        ...
        finish_btn = QPushButton("Confirm")
...
def message_input(msg, title="hint"):
    im = InputMessageDialog(title, msg)
    im.exec_()
