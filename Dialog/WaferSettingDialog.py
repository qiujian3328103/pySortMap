...
class ShowWaferSettingDialog(QDialog, Ui_App_Setting_Dialog):
    ...
    def __init__(self):
        ...
        self.toolButton_wafer_substrate_color.clicked.connect(lambda:self.pickColor(toolButton=self.toolButton_wafer_substrate_color))
    ...
    def emitWaferLayoutSetting(self):
        ...
        layout_props = {'die_line_type': die_line_type,
        ...
        self.wafer_layout_changed.emit(layout_props)
